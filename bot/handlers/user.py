...
async def start_booking(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        ...
        "🗺️ <b>Recommended:</b> Use location pin for accuracy!\n\n"
        "1. 📎 Tap the attachment icon\n"
        "2. 📍 Select 'Location'\n"
        "3. 🗺️ Pin your exact pickup location\n\n"
...
async def receive_pickup_address(message: Message, state: FSMContext):
    ...
    if message.location:
        ...
        await message.answer(
            ...
            f"🗺️ Location: {message.location.latitude:.4f}, {message.location.longitude:.4f}\n\n"
    ...
    if _looks_like_phone(message.text or ""):
        await message.answer(
            ...
            "1. 🗺️ Tap the 📎 attachment icon\n"
            "2. 📍 Select 'Location'\n"
            "3. 🗺️ Pin your exact location\n\n"
...
async def receive_pickup_slot(callback: CallbackQuery, state: FSMContext):
    ...
    await callback.message.edit_text(
        ...
        "1. 📎 Tap the attachment icon\n"
        "2. 📍 Select 'Location'\n"
        "3. 🗺️ Pin your exact drop-off location\n\n"
        "📝 Or type the street address:",
    )
